<x-app-layout>
    ...
    <div class="flex flex-col items-center mt-6 bg-gray-100 sm:justify-center sm:pt-0 dark:bg-gray-900">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('card.register') }}" method="post">
                        ...
                        <div class="pt-3">
                            ...
                            <x-text-input id="qr_code" name="qr_code" type="text" class="block w-full mt-1"
                                :value="old('qr_code')" required autocomplete="qr_code" />
                            <x-input-error class="mt-2" :messages="$errors->get('qr_code')" />
                        </div>
                        <br>
                        <div class="items-center">
                            <div id="reader" class="w-full" width="600px"></div>
                        </div>
                        <br>
                        <x-secondary-button id="writeButton">{{ __('Write') }}</x-secondary-button>
    ...
    <script type="text/javascript">
        writeButton.addEventListener("click", async (e) => {
            ...
            var url = document.getElementById("qr_code").value;
            if(url)
            {
                try {
